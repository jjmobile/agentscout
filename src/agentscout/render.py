...
def services_note(ns: str, now: datetime) -> str:
    ...
    return formatter.note_line(
        ...
        f"what=signed portable reputation attestation, market-grade (observed behaviour; not protocol-grade, "
        f"cf. FLOP Yellow Paper E.36) (Ed25519, verifies offline with just the object+our did:key) "
